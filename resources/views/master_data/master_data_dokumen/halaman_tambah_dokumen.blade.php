                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="file-upload-preview">
                            <form name="form_upload" action="{{url('/simpan_dokumen')}}" method="post" enctype="multipart/form-data" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                                @csrf
                                ...
                                <div class="dz-message needsclick">
                                <p class="bor-file" style="word-break: break-word; "><span id="dokumen_lht"></span> </p>
                                </div>
                        </div> <!-- end preview-->
                    </div> <!-- end tab-content-->
    ...
    <script>
        ...
        $(function() {
          $("form[name='form_upload']").validate({
            ...
            messages: {
              file_dokumen: "<span style='color: red;'>File tidak boleh kosong</span>",
            },
