...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Halaman Update Profil</h4>
        </div>
    </div>
</div> 
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{url('/simpan_profil')}}" method="post" enctype="multipart/form-data" name="form_Up_profil">
                  @csrf
                  <div class="table-responsive-sm">
                  <table class="table" style="border-color: #fff ">
                      <tbody>
                          <tr>
                            <td data-title="nama_lengkap" style="width: 15%;">Nama Lengkap</td>
                            <td >&nbsp;:</td>
                            <td data-title="nama_lengkap" class="formulir-border" style="width: 85%; padding-left:0.8em"><input type="text" value="{{$nama}}" class="form-control" id="nama_lengkap" readonly></td>
                          </tr>
                          <tr>
                            <td data-title="nip" style="width: 15%;">NIP</td>
                            <td >&nbsp;:</td>
                            <td data-title="nip" class="formulir-border" style="width: 85%; padding-left:0.8em"><input type="text" value="{{$nip}}" class="form-control" id="nip" readonly></td>
                          </tr>
                          <tr>
                            <td data-title="email" style="width: 15%;">Email</td>
                            <td >&nbsp;:</td>
                            <td data-title="email" class="formulir-border" style="width: 85%; padding-left:0.8em"><input type="text" value="{{$email}}" class="form-control" id="email" readonly></td>
                          </tr>
                          <tr>
                        ...
                        <tr>
                            ...
                            <td data-title="jk" class="formulir-border" style="width: 85%; padding-left:0.8em">
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadio3" name="jk" value="L" class="form-check-input">Laki-laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadio4" name="jk" value="P" class="form-check-input">
                          ...
                          <tr>
                            ...
                            <td data-title="opd" class="formulir-border" style="width: 85%; padding-left:0.8em;">
                              <select class="form-control select2" name="opd_id" id="opd" data-toggle="select2" style="border: 1px solid rgb(161, 161, 161);">
                                ...
                                @foreach ($opd as $jd)
                                <option value="{{$jd->id}}">{{$jd->opd}}</option>
                                @endforeach
                            </select>
...
<script>
    ...
    @endif
    $(function() {
          $("form[name='form_Up_profil']").validate({
            rules: {
              alamat: {
                required: true,
                minlength: 15
